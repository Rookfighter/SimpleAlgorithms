...
namespace sa
{
    static void merge(std::vector<int> &p_toSortA, const int p_leftA,
            const int p_rightA, std::vector<int> &p_toSortB, const int p_leftB,
            const int p_rightB, std::vector<int> &p_toSortC, const int p_leftC)
    {
        int a = p_leftA;
        int b = p_leftB;
        int c = p_leftC;
    ...
    static void mergeSort(std::vector<int> &p_toSortA, const int p_left,
            const int p_right, std::vector<int> &p_toSortB)
    {
        if(p_right > p_left) {
            ...
            merge(p_toSortB, p_left, mid, p_toSortB, mid + 1, p_right,
                    p_toSortA, p_left);
        }
    }
